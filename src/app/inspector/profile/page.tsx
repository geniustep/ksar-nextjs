...
export default function InspectorProfilePage() {
  ...
  return (
    <DashboardLayout>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-neutral-dark">الملف الشخصي</h1>
        <p className="text-gray-500 mt-1">تحرير بيانات حسابك</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <form onSubmit={handleSaveProfile} className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-xl p-3">
              ...
              <p className="font-medium text-primary-600">مراقب</p>
            </div>
        ...
        <Card>
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <h3 className="text-sm font-semibold text-gray-700 mb-3">معلومات الحساب</h3>
